...
//   // Helper function to derive prefix
...
//     const tyre = cabDetail.tyrePuncture_repairAmount?.reduce((sum, amount) => sum + Number.parseFloat(amount || "0"), 0) || 0
//     const servicing = cabDetail.servicing_amount?.reduce((sum, amount) => sum + Number.parseFloat(amount || "0"), 0) || 0
//     const other = cabDetail.otherProblems_amount?.reduce((sum, amount) => sum + Number.parseFloat(amount || "0"), 0) || 0
...
//       if (companyLogo) {
//         try {
//           doc.addImage(companyLogo, "JPEG", margin + 8, currentY + 8, 30, 15)
//         } catch (e) {
...
//     //   doc.text("CUSTOMER AND TRIP DETAILS", margin + 3, currentY )
...
//             `Drop: ${item.dropLocation || item.CabDetail?.location_to || "N/A"}`,
//           ],
//           [
...
//       doc.setFont("helvetica", "normal")
//       doc.setTextColor(...colors.text)
//       doc.text(`Cab Number: ${item.CabDetail?.cabNumber || "N/A"}`, vehicleCardX + 2, currentY + 10)
//       doc.text(`Model: ${item.vehicleType || "N/A"}`, vehicleCardX + 2, currentY + 16)
//       doc.text(`Year: ${item.CabDetail?.year || "N/A"}`, vehicleCardX + 2, currentY + 22)
//       doc.text(`Fuel Amount: ${item.CabDetail?.fuel_type || "N/A"}`, vehicleCardX + 2, currentY + 28)
...
//       if (signature) {
//         try {
//           doc.addImage(signature, "JPEG", signatureBoxX + 8, currentY + 10, 44, 12)
//         } catch (e) {
//           console.warn("Signature could not be added:", e)
//         }
//       }

//       // Signature line - Professional Blue
//       doc.setDrawColor(...colors.secondary)
//       doc.setLineWidth(0.5)
//       doc.line(signatureBoxX + 8, currentY + 20, signatureBoxX + 52, currentY + 20)

//       doc.setFontSize(7)
//       doc.setFont("helvetica", "normal")
//       doc.setTextColor(...colors.text)
//       doc.text("Authorized Signatory", signatureBoxX + signatureBoxWidth / 2, currentY + 23, { align: "center" })
//       doc.text(`Date: ${reportDate}`, signatureBoxX + signatureBoxWidth / 2, currentY + 26, { align: "center" })
